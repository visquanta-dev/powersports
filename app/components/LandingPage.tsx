...
export type LandingVariant = 'sia' | 'william';
...
type VariantConfig = {
  ...
  mobileGlowClass: string;
  desktopWrapperClass: string;
  desktopFrameClass: string;
  desktopGlowClass: string;
  desktopSizes: string;
};

const VARIANTS: Record<LandingVariant, VariantConfig> = {
  sia: {
    heroSrc: '/images/sia-small.png',
    heroAlt: 'Sia Small, VisQuanta',
    gridColsClass: 'grid lg:grid-cols-[1fr_560px] gap-6 lg:gap-4 items-end',
    mobileFrameClass: 'relative w-[240px] h-[320px]',
    mobileGlowClass:
      'absolute bottom-0 left-1/2 -translate-x-1/2 w-[220px] h-[140px] bg-[#FF7404]/15 rounded-full blur-[60px]',
    desktopWrapperClass: 'hidden lg:block relative -ml-12',
    desktopFrameClass: 'relative w-[560px] h-[680px]',
    desktopGlowClass:
      'absolute bottom-0 left-1/2 -translate-x-1/2 w-[420px] h-[260px] bg-[#FF7404]/10 rounded-full blur-[80px]',
    desktopSizes: '560px',
  },
  william: {
    heroSrc: '/images/william.png',
    heroAlt: 'William, VisQuanta',
    gridColsClass: 'grid lg:grid-cols-[1fr_420px] gap-6 lg:gap-4 items-end',
    mobileFrameClass: 'relative w-[200px] h-[320px]',
    mobileGlowClass:
      'absolute bottom-0 left-1/2 -translate-x-1/2 w-[200px] h-[140px] bg-[#FF7404]/15 rounded-full blur-[60px]',
    desktopWrapperClass: 'hidden lg:block relative',
    desktopFrameClass: 'relative w-[420px] h-[520px]',
    desktopGlowClass:
      'absolute bottom-0 left-1/2 -translate-x-1/2 w-[340px] h-[220px] bg-[#FF7404]/10 rounded-full blur-[80px]',
    desktopSizes: '420px',
  },
};
          ...
          <div className={v.gridColsClass}>
            ...
            >
              ...
              <div className="lg:hidden relative w-full flex justify-center">
                <div className={v.mobileFrameClass}>
                  <div className={v.mobileGlowClass} />
                  <Image
                    src={v.heroSrc}
                    alt={v.heroAlt}
                    fill
                    sizes={v.desktopSizes}
              ...
              {/* Desktop: full cutout */}
              <div className={v.desktopWrapperClass}>
                <div className={v.desktopFrameClass}>
                  <div className={v.desktopGlowClass} />
                  <Image
                    src={v.heroSrc}
                    alt={v.heroAlt}
                    fill
